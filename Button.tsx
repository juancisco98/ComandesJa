...
const Button: React.FC<ButtonProps> = ({ 
  ...
  // Base styles
  const baseStyles = "font-heading font-bold rounded-2xl transition-all duration-200 active:scale-95 flex items-center justify-center gap-2 relative overflow-hidden group";
  ...
  const variants = {
    ...
    cta: "bg-[#16a34a] text-white shadow-lg border-t border-white/20 hover:bg-[#15803d] hover:shadow-green-900/20 hover:-translate-y-0.5",
  };
