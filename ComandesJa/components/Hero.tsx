    ...
    <section className="relative pt-32 pb-20 px-4 md:px-8 overflow-hidden min-h-screen flex items-center justify-center">
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="text-center lg:text-left z-10 space-y-8 max-w-3xl mx-auto lg:mx-0">
          ...
          {/* Badge - Glassy */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/70 backdrop-blur-md border border-white/50 shadow-sm mx-auto lg:mx-0 animate-float">
          ...
          <div className="flex flex-col gap-4 relative z-20">
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2">
              ...
              <Button
                ...
                className="w-full sm:w-auto rounded-full bg-white/70 backdrop-blur-md border border-white/60 hover:bg-white/90 text-gray-800"
              >
                <Store size={20} />
                Ver Demo como Local
              </Button>
            ...
            <div className="text-center lg:text-left">
              <button
                onClick={onDemoClick}
                aria-label="Ver demo de la aplicación para clientes"
                className="group inline-flex items-center gap-2 text-sm font-semibold text-gray-500 hover:text-primary transition-all py-2 px-3 rounded-lg hover:bg-white/40 cursor-pointer"
              >
