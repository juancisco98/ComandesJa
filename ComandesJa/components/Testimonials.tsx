    ...
    <section id="testimonials" className="py-24 px-4 bg-gradient-to-b from-transparent to-primary/5 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="flex justify-center gap-4 mt-8">
          <button onClick={prev} aria-label="Ver testimonio anterior" className="p-3 rounded-full bg-white shadow-clay hover:scale-110 transition-transform text-primary">
            <ChevronLeft size={24} />
          </button>
          ...
          <button onClick={next} aria-label="Ver siguiente testimonio" className="p-3 rounded-full bg-white shadow-clay hover:scale-110 transition-transform text-primary">
