      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <ClayCard key={feature.id} className="p-8 group h-full flex flex-col items-start hover:bg-white transition-all duration-300 hover:scale-102 cursor-default">
